...
export const galleryItems: GalleryItem[] = [
  ...
  { id: 'pr2', title: 'Sorting facility', image: '/images/production-facility-husks.jpg', alt: 'Coconut husks stored neatly inside the Coconiq production facility', category: 'production' },
  ...
  { id: 'pr7', title: 'Baling workers', image: '/images/production-baling-machine.jpg', alt: 'Baling machine used in the production area', category: 'production' },
  ...
  { id: 'a1', title: 'Seedling potting', image: '/images/application-hydroponics.jpg', alt: 'Cocopeat used in a clean hydroponics nursery setup', category: 'applications' },
]
