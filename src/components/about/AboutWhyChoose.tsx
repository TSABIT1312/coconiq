...
export function AboutWhyChoose(): ReactElement {
  return (
    <section aria-labelledby="about-why-heading" className="bg-background">
      <Container className="section-y flex flex-col gap-10 md:gap-14">
        <SectionHeading
          eyebrow="Why Coconiq"
          title={
            <span id="about-why-heading">Reliable cocopeat, every order</span>
          }
